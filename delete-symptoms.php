...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql = "DELETE FROM symptoms WHERE SymptomsId = ?";
...
<form action="delete-symptoms.php" method="POST">
<div class="alert alert-dark" role="alert" id="delete">
  ...
  <a href="symptoms.php"><button type="button" class="btn btn-danger" style="margin-left: 50px ;">No</button></a>
</div>
</form>
</div>
